<template>
    <div class="card">
        <h3>Documentation</h3>
        <p class="bg-primary border-round p-3">This page covers the Vite version, for Nuxt 3 visit the <a href="https://github.com/primefaces/HARPER-nuxt" class="font-bold bg-primary hover:underline">HARPER-nuxt</a> repository instead.</p>
        <h5>Getting Started</h5>
        <p>
            HARPER is an application template for Vue based on the <a href="https://github.com/vuejs/create-vue" class="font-medium text-primary hover:underline">create-vue</a>, the recommended way to start a <strong>Vite-powered</strong> Vue
            projects. To get started, clone the <a href="https://github.com/primefaces/HARPER-vue" class="font-medium text-primary hover:underline">repository</a> from GitHub and install the dependencies with npm or yarn.
        </p>
        ...
        <p>Next step is running the application using the serve script and navigate to <i>http://localhost:5173/</i> to view the application. That is it, you may now start with the development of your application using the HARPER template.</p>

        <pre class="app-code"><code> npm run dev </code></pre>

        <h5>Structure</h5>
        <p>HARPER consists of a couple folders, demos and layout have been separated so that you can easily remove what is not necessary for your application.</p>
        ...
        <p>HARPER theming is based on the PrimeVue theme being used. Default theme is <b>lara-light-indigo</b>.</p>
